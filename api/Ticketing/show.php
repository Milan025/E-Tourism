		...
		<td width="45%">
              ...
              <div class="login-html">
                  <form action="booked.php" method="post">
                    ...
                    <div class="buttn">
                        <center>
                        <button class="button button2" id="btclr" type="submit"><span>Proceed to Book</span></button>						
						</center>
                    </div><br>
                ...
                <td width="45%">
                    ...
                    echo "<tr><td><table border='1' width='200px'><tr><td><b>From:</b></td><td>".$_POST['start'].'</td></tr><br>';
                    echo "<tr><td><b>To:</b></td><td>".$_POST['destination'].'</td></tr><br>';
